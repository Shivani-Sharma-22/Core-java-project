...
public class IRCTCAPP {
    ...
    public void register(){
        ...
        userService.registerUser(username,password,fullname,contact,address);
    ...
    private void showUserMenu(){
        while (userService.isloging()){
            System.out.println("\n--------- User menu ---------");
            System.out.println("1.Search Trains:");
            System.out.println("2.Booked Ticket:");
            System.out.println("3.View My Tickets:");
            System.out.println("4.Cancel My Tickets:");
    ...
    private void exitApp(){
        System.out.println("Thank you for using RICTC App.");
        System.exit(0);
    }
}
